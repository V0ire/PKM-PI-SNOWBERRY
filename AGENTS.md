...
7. `docs/02-frontend/DESIGN-tokens.md`
...
3. UI visual, warna, font, spacing, style: ikuti `docs/02-frontend/DESIGN-tokens.md`
...
- Frontend harus mengikuti `DESIGN-tokens.md`.
